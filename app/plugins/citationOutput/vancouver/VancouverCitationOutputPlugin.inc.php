...
import('core.plugins.citationOutput.vancouver.PKPVancouverCitationOutputPlugin');

class VancouverCitationOutputPlugin extends VancouverCitationOutputPlugin {
	/**
	 * Constructor
	 */

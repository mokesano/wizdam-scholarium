...
import('app.classes.handler.Handler');
...
class ObjectsForReviewEditorHandler extends Handler {
	...
	function objectsForReview($args, &$request) {
		...
		$ofrPlugin->import('app.classes.ObjectForReviewAssignment');
	...
	function objectsForReviewSettings($args, &$request) {
		...
		$ofrPlugin =& $this->_getObjectsForReviewPlugin();
		$ofrPlugin->import('app.classes.form.ObjectsForReviewSettingsForm');
	...
	function editObjectForReview($args, &$request) {
		...
		$ofrPlugin =& $this->_getObjectsForReviewPlugin();
		$ofrPlugin->import('app.classes.form.ObjectForReviewForm');
	...
	function removeObjectForReviewCoverPage($args, &$request) {
		...
		if ($coverPageSetting) {
			...
			$ofrPlugin =& $this->_getObjectsForReviewPlugin();
			$ofrPlugin->import('app.classes.ReviewObjectMetadata');
	...
	function editObjectForReviewAssignment($args, &$request) {
		...
		$ofrPlugin =& $this->_getObjectsForReviewPlugin();
		$ofrPlugin->import('app.classes.form.ObjectForReviewAssignmentForm');

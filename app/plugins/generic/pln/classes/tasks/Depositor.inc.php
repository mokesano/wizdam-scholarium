...
import('core.classes.scheduledTask.ScheduledTask');
...
class Depositor extends ScheduledTask {
	...
	function executeActions() {
		...
		while ($journal =& $journals->next()) {
			...
			$this->_plugin->import('app.classes.Deposit');
			$this->_plugin->import('app.classes.DepositObject');
			$this->_plugin->import('app.classes.DepositPackage');

...
import('app.classes.plugins.ReportPlugin');
import('app.plugins.reports.counter.classes.CounterReport');

class CounterReportPlugin extends ReportPlugin {

	/**
	 * @see Plugin::register($category, $path)
	 */
		...
		if ($request->getUserVar('type')) {
			...
			switch ($type) {
				...
				case 'reportxml':
					...
					import('app.plugins.reports.counter.classes.LegacyJR1');

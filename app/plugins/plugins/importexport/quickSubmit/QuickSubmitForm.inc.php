...
class QuickSubmitForm extends Form {
	...
	function QuickSubmitForm(&$plugin, $request) {
		...
		import('core.classes.validation.ValidatorORCID');
	...
	function execute() {
		...
		foreach (array_keys($tempFileIds) as $locale) {
			...
			if ($temporaryFile) {
				...
				if (strstr($fileType, 'html')) {
					import('app.classes.article.ArticleHTMLGalley');
					$galley = new ArticleHTMLGalley();
				} else {
					import('app.classes.article.ArticleGalley');
		...
		import('app.classes.submission.author.AuthorAction');
		...
		import('app.classes.submission.sectionEditor.SectionEditorAction');
		...
		import('app.classes.author.form.submit.AuthorSubmitForm');
		AuthorSubmitForm::assignEditors($article);

		$articleDao->updateArticle($article);

		// Add to end of editing queue
		import('app.classes.submission.editor.EditorAction');

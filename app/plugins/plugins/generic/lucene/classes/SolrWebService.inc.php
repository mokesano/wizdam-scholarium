...
import('core.classes.webservice.WebServiceRequest');
import('core.classes.webservice.XmlWebService');
import('core.classes.xml.XMLCustomWriter');
import('app.plugins.generic.lucene.classes.SolrSearchRequest');
import('app.classes.search.ArticleSearch');

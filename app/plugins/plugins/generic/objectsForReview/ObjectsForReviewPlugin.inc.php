...
class ObjectsForReviewPlugin extends GenericPlugin {
	...
	function registerDAOs() {
		$this->import('app.classes.ReviewObjectTypeDAO');
		$this->import('app.classes.ReviewObjectMetadataDAO');
		$this->import('app.classes.ObjectForReviewPersonDAO');
		$this->import('app.classes.ObjectForReviewDAO');
		$this->import('app.classes.ObjectForReviewSettingsDAO');
		$this->import('app.classes.ObjectForReviewAssignmentDAO');

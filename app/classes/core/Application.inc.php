...
import('core.classes.core.Application');
import('app.classes.statistics.StatisticsHelper');
...
class Application extends CoreApplication {
	...
	function getDAOMap() {
		return array_merge(parent::getDAOMap(), array(
			...
			'CommentDAO' => 'core.library.classes.comment.CommentDAO',
			...
			'AppCompletedPaymentDAO' => 'classes.payment.ojs.AppCompletedPaymentDAO',
			...
			'QueuedPaymentDAO' => 'core.library.classes.payment.QueuedPaymentDAO',
			...
			'ReviewFormDAO' => 'core.library.classes.reviewForm.ReviewFormDAO',
			'ReviewFormElementDAO' => 'core.library.classes.reviewForm.ReviewFormElementDAO',
			'ReviewFormResponseDAO' => 'core.library.classes.reviewForm.ReviewFormResponseDAO',

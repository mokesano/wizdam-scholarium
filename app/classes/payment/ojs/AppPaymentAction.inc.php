...
/**
 * @file classes/payment/ojs/AppPaymentAction.inc.php
 *
...
class AppPaymentAction {
	 ...
	 */
	 function payments($args) {
		import('app.classes.payment.ojs.form.PaymentSettingsForm');
	...
	function payMethodSettings() {
		...
		$journal =& Request::getJournal();
		import('app.classes.payment.ojs.form.PayMethodSettingsForm');

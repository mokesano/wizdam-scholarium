...
import('core.classes.submission.reviewAssignment.PKPReviewAssignmentDAO');

class ReviewAssignmentDAO extends ReviewAssignmentDAO {
	var $articleFileDao;
	var $suppFileDao;
	...
	/**
	* @see ReviewAssignmentDAO::getReviewRoundJoin()
	*/

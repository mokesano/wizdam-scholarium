...
import('app.classes.security.authorization.internal.JournalPolicy');
import('core.classes.security.authorization.RoleBasedHandlerOperationPolicy');
...
class OjsSubmissionAccessPolicy extends JournalPolicy {
	...
	function OjsSubmissionAccessPolicy(&$request, &$args, $roleAssignments, $submissionParameterName = 'articleId') {
		...
		import('app.classes.security.authorization.internal.SectionEditorSubmissionRequiredPolicy');
		...
		import('app.classes.security.authorization.internal.SectionSubmissionAssignmentPolicy');
		...
		import('app.classes.security.authorization.internal.CopyeditorSubmissionRequiredPolicy');
		...
		import('app.classes.security.authorization.internal.CopyeditorSubmissionAssignmentPolicy');

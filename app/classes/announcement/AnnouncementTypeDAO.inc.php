...
import('app.classes.announcement.AnnouncementType');
import('core.classes.announcement.PKPAnnouncementTypeDAO');

class AnnouncementTypeDAO extends AnnouncementTypeDAO {
	/**
	 * Constructor
	 */
	...
	/**
	 * @see AnnouncementTypeDAO::newDataObject
	 */

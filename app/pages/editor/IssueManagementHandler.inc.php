...
class IssueManagementHandler extends EditorHandler {
	...
	function createIssue($args, $request) {
		...
		import('app.classes.issue.form.IssueForm');
	...
	function uploadIssueGalley($args, $request) {
		...
		import('app.classes.issue.form.IssueGalleyForm');
	...
	function deleteIssueGalley($args, $request) {
		...
		if (isset($galley)) {
			import('app.classes.file.IssueFileManager');
	...
	function notifyUsers($args, $request) {
		...
		import('core.classes.mail.MassMail');
		...
		if ($request->getUserVar('send') && !$email->hasErrors()) {
			...
			import('core.classes.validation.ValidatorEmail');
			$emails = array();

...
class SubmissionEditHandler extends SectionEditorHandler {
	...
	function submission($args, &$request) {
		...
		if ($enableComments) {
			import('app.classes.article.Article');
		...
		import('app.classes.payment.ojs.AppPaymentManager');
	...
	function submissionRegrets($args, &$request) {
		...
		import('app.classes.submission.reviewAssignment.ReviewAssignment');
	...
	function submissionEditing($args, $request) {
		...
		import('app.classes.issue.IssueAction');
	...
	function createReviewer($args, &$request) {
		...
		import('app.classes.sectionEditor.form.CreateReviewerForm');
	...
	function addSuppFile($args, $request) {
		...
		import('app.classes.submission.form.SuppFileForm');
	...
	function _uploadGalley($fileName = null, $request) {
		...
		import('app.classes.submission.form.ArticleGalleyForm');
	...
	function proofGalleyFile($args, &$request) {
		...
		import('app.classes.file.ArticleFileManager'); // FIXME
	...
	function selectProofreader($args, $request) {
		...
		if ($userId && $articleId && $roleDao->userHasRole($journal->getId(), $userId, ROLE_ID_PROOFREADER)) {
			import('app.classes.submission.proofreader.ProofreaderAction');
	...
	function downloadLayoutTemplate($args, &$request) {
		...
		import('app.classes.file.JournalFileManager');

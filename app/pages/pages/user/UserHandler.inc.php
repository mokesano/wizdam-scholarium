...
class UserHandler extends Handler {
	...
	function viewCaptcha($args, $request) {
		...
		import('core.classes.captcha.CaptchaManager');
	...
	function purchaseSubscription($args, &$request) {
		...
		if ($institutional == 'institutional') {
			$institutional = true;
			import('app.classes.subscription.form.UserInstitutionalSubscriptionForm');
			$subscriptionDao =& DAORegistry::getDAO('InstitutionalSubscriptionDAO');
		} else {
			$institutional = false;
			import('app.classes.subscription.form.UserIndividualSubscriptionForm');
			$subscriptionDao =& DAORegistry::getDAO('IndividualSubscriptionDAO');
		}
		...
		if (isset($subscriptionId)) {
			...
			import('app.classes.subscription.Subscription');
			$validStatus = array(

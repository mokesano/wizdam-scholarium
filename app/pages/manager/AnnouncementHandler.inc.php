...
import('core.pages.manager.PKPAnnouncementHandler');
...
class AnnouncementHandler extends AnnouncementHandler {
	 ...
	 * @see AnnouncementHandler::announcements
	 * @param $args array
	 ...
	 * @see AnnouncementHandler::announcementTypes
	 * @param $args array
	 * @param $request PKPRequest
	 */
	...
	/**
	 * @see AnnouncementHandler::getContextId()
	 */
	...
	/**
	 * @see AnnouncementHandler::_getAnnouncementTypes
	 * @param $request PKPRequest
	 * @param $rangeInfo object optional
	 */

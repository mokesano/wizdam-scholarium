...
import('app.classes.notification.Notification');
...
class NotificationHandler extends Handler {
	...
	function settings($args, &$request) {
		...
		$user = $request->getUser();
		if(isset($user)) {
			import('app.classes.notification.form.NotificationSettingsForm');
	...
	function subscribeMailList($args, &$request) {
		...
		if(!isset($user)) {
			import('core.classes.notification.form.NotificationMailingListForm');

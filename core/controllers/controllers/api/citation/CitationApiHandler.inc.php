...
class CitationApiHandler extends Handler {
	/**
	 * Constructor.
	 */
	...
	function authorize(&$request, $args, $roleAssignments) {
		import('core.classes.security.authorization.PKPProcessAccessPolicy');
		$this->addPolicy(new ProcessAccessPolicy($request, $args, 'checkAllCitations'));

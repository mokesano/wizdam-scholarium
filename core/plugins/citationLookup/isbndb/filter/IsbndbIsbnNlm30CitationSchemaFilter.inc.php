...
import('core.plugins.citationLookup.isbndb.filter.IsbndbNlm30CitationSchemaFilter');
...
class IsbndbIsbnNlm30CitationSchemaFilter extends IsbndbNlm30CitationSchemaFilter {
	...
	function getClassName() {
		return 'core.library.plugins.citationLookup.isbndb.filter.IsbndbIsbnNlm30CitationSchemaFilter';
	}

...
import('core.plugins.metadata.nlm30.filter.Nlm30CitationSchemaFilter');
import('core.plugins.metadata.nlm30.filter.Openurl10Nlm30CitationSchemaCrosswalkFilter');
import('core.classes.filter.SetFilterSetting');
...
class ParaciteRawCitationNlm30CitationSchemaFilter extends Nlm30CitationSchemaFilter {
	...
	function getClassName() {
		return 'core.library.plugins.citationParser.paracite.filter.ParaciteRawCitationNlm30CitationSchemaFilter';
	}
	...
	function &process($citationString) {
		...
		switch($metadata['genre']) {
			...
			case OPENURL10_GENRE_DOCUMENT:
				...
				$openurl10SchemaName = 'core.library.plugins.metadata.openurl10.schema.Openurl10BookSchema';
			...
			default:
				...
				$openurl10SchemaName = 'core.library.plugins.metadata.openurl10.schema.Openurl10JournalSchema';

...
import('core.classes.filter.PersistableFilter');
import('core.classes.filter.BooleanFilterSetting');

import('core.classes.metadata.MetadataDescription');
import('core.plugins.metadata.nlm30.schema.Nlm30CitationSchema');
import('core.plugins.metadata.nlm30.schema.Nlm30NameSchema');
import('core.plugins.metadata.nlm30.filter.PersonStringNlm30NameSchemaFilter');
import('core.classes.metadata.DateStringNormalizerFilter');

import('core.classes.webservice.XmlWebService');

import('core.classes.xml.XMLHelper');
import('core.classes.xslt.XSLTransformationFilter');
...
class Nlm30CitationSchemaFilter extends PersistableFilter {
	...
	function constructSearchStrings(&$searchTemplates, &$citationDescription) {
		...
		import('core.plugins.metadata.nlm30.filter.Nlm30NameSchemaPersonStringFilter');

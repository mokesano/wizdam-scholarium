...
class CoreApplication {
	...
	function &getDispatcher() {
		...
		if (is_null($dispatcher)) {
			...
			// Inject dependency
			$dispatcher->setApplication(CoreApplication::getApplication());
	...
	static function defineExposedConstant($name, $value) {
		...
		$constants =& CoreApplication::getExposedConstants(); // KEEP reference assignment for static access
...
/**
 * @see CoreApplication::defineExposed
 */
function define_exposed($name, $value) {
	...
	if (defined('E_DEPRECATED')) $errorReportingLevel &= ~E_DEPRECATED;
	@error_reporting($errorReportingLevel);
	CoreApplication::defineExposedConstant($name, $value); // FIXED: Sekarang bisa dipanggil static

...
import('core.classes.controllers.listbuilder.ListbuilderHandler');
import('core.classes.controllers.listbuilder.ListbuilderList');
...
class MultipleListsListbuilderHandler extends ListbuilderHandler {
	...
	function initFeatures($request, $args) {
		...
		import('core.classes.controllers.grid.feature.OrderMultipleListsItemsFeature');

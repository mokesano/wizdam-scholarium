...
import('core.classes.form.FormError');
import('core.classes.form.FormBuilderVocabulary');

// Import all form validators for convenient use in sub-classes
import('core.classes.form.validation.FormValidatorAlphaNum');
import('core.classes.form.validation.FormValidatorArray');
import('core.classes.form.validation.FormValidatorArrayCustom');
import('core.classes.form.validation.FormValidatorControlledVocab');
import('core.classes.form.validation.FormValidatorCustom');
import('core.classes.form.validation.FormValidatorCaptcha');
import('core.classes.form.validation.FormValidatorReCaptcha');
import('core.classes.form.validation.FormValidatorDate');
import('core.classes.form.validation.FormValidatorEmail');
import('core.classes.form.validation.FormValidatorInSet');
import('core.classes.form.validation.FormValidatorLength');
import('core.classes.form.validation.FormValidatorListbuilder');
import('core.classes.form.validation.FormValidatorLocale');
import('core.classes.form.validation.FormValidatorLocaleEmail');
import('core.classes.form.validation.FormValidatorPost');
import('core.classes.form.validation.FormValidatorRegExp');
import('core.classes.form.validation.FormValidatorUri');
import('core.classes.form.validation.FormValidatorUrl');
import('core.classes.form.validation.FormValidatorLocaleUrl');
import('core.classes.form.validation.FormValidatorISSN');
import('core.classes.form.validation.FormValidatorORCID');
	...
	function validate($callHooks = true) {
		...
		if (!defined('SESSION_DISABLE_INIT')) {
			...
			if (!$this->isValid() && $user) {
				...
				import('app.classes.notification.NotificationManager');

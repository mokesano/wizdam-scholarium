...
// Import action class.
import('core.classes.linkAction.LinkAction');
import('core.classes.linkAction.LegacyLinkAction');

// Import grid classes.
import('core.classes.controllers.grid.GridColumn');
import('core.classes.controllers.grid.GridRow');

// Import JSON class for use with all AJAX requests.
import('core.classes.core.JSONMessage');
...
class GridHandler extends Handler {
	...
	function _renderCellInternally(&$request, &$row, &$column) {
		...
		if ( is_null($element) && $row->getIsModified() ) {
			import('core.classes.controllers.grid.GridCellProvider');

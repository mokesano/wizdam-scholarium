...
import('core.classes.controllers.grid.filter.PKPFilterGridRow');
import('core.classes.controllers.grid.filter.FilterGridCellProvider');

// import metadata framework classes
import('core.classes.metadata.MetadataDescription');


class FilterGridHandler extends GridHandler {
	...
	function editFilter(&$args, &$request, $newFilter = false) {
		...
		// Form handling
		import('core.classes.controllers.grid.filter.form.FilterForm');

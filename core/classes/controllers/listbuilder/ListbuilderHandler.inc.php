...
import('core.classes.controllers.listbuilder.ListbuilderGridRow');
import('core.classes.controllers.listbuilder.ListbuilderGridColumn');
import('core.classes.controllers.listbuilder.MultilingualListbuilderGridColumn');
...
class ListbuilderHandler extends GridHandler {
	...
	function initialize(&$request, $addItemLink = true) {
		...
		if ($addItemLink) {
			import('core.classes.linkAction.request.NullAction');
			$this->addAction(
				new LinkAction(
					'addItem',
					new NullAction(),
	...
	function unpack(&$request, $data, $deletionCallback = null, $insertionCallback = null, $updateCallback = null) {
		...
		import('core.classes.core.JSONManager');
